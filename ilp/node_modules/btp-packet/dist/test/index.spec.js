...
describe('BTP/1.0', () => {
    ...
    describe('Response', () => {
        it('should serialize/deserialize without losing data', function () {
            ...
            chai_1.assert.deepEqual(Btp.serialize(obj), this.buffers.response);
            chai_1.assert.deepEqual(Btp.deserialize(this.buffers.response), obj);
        });
    });
    describe('Error', () => {
        it('should serialize/deserialize without losing data', function () {
            ...
            chai_1.assert.deepEqual(Btp.serialize(obj), this.buffers.error);
            chai_1.assert.deepEqual(Btp.deserialize(this.buffers.error), obj);
        });
    });
    describe('Message', () => {
        it('should serialize/deserialize without losing data', function () {
            ...
            chai_1.assert.deepEqual(Btp.serialize(obj), this.buffers.message);
            chai_1.assert.deepEqual(Btp.deserialize(this.buffers.message), obj);
        });
    });
    describe('Transfer', () => {
        it('should serialize/deserialize without losing data', function () {
            ...
            chai_1.assert.deepEqual(Btp.serialize(obj), this.buffers.transfer);
            chai_1.assert.deepEqual(Btp.deserialize(this.buffers.transfer), obj);
        });
    });
    describe('serializeResponse', () => {
        it('should serialize without losing data', function () {
            const buf = Btp.serializeResponse(1, this.protocolData);
            chai_1.assert.deepEqual(buf, this.buffers.response);
        });
    });
    describe('serializeError', () => {
        it('should serialize without losing data', function () {
            const buf = Btp.serializeError(this.btpError, 1, this.protocolData);
            chai_1.assert.deepEqual(buf, this.buffers.error);
        });
    });
    describe('serializeMessage', () => {
        it('should serialize without losing data', function () {
            const buf = Btp.serializeMessage(1, this.protocolData);
            chai_1.assert.deepEqual(buf, this.buffers.message);
        });
    });
    describe('serializeTransfer', () => {
        it('should serialize without losing data', function () {
            const buf = Btp.serializeTransfer({ amount: '100' }, 1, this.protocolData);
            chai_1.assert.deepEqual(buf, this.buffers.transfer);
        });
    });
    describe('registerProtocolNames', function () {
        it('caches the protocol names', function () {
            Btp.registerProtocolNames(this.protocolData.map((protocol) => protocol.protocolName));
            const buf = Btp.serializeMessage(1, this.protocolData);
            chai_1.assert.deepEqual(buf, this.buffers.message);
        });
    });
