  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>102/111</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Predictor, Reader, Writer, WriterInterface } from 'oer-utils'
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >typeToString </span>(type: Type) {
  switch (type) {
    case Type.TYPE_RESPONSE: <span class="cstat-no" title="statement not covered" >return 'TYPE_RESPONSE'</span>
    case Type.TYPE_ERROR: <span class="cstat-no" title="statement not covered" >return 'TYPE_ERROR'</span>
    case Type.TYPE_MESSAGE: <span class="cstat-no" title="statement not covered" >return 'TYPE_MESSAGE'</span>
    case Type.TYPE_TRANSFER: <span class="cstat-no" title="statement not covered" >return 'TYPE_TRANSFER'</span>
    default: <span class="cstat-no" title="statement not covered" >throw new Error('Unrecognized BTP packet type')</span>
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw new Error('protocolData must be an array')</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw new Error(`error code must be 3 characters, got: "${data.code}"`)</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw new Error('Unrecognized type')</span>
  }
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Aug 29 2019 20:32:40 GMT+0000 (UTC)
</div>
</div>
