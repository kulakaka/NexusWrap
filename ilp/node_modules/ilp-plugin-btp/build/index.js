...
class AbstractBtpPlugin extends eventemitter2_1.EventEmitter2 {
    ...
    async connect() {
        ...
        if (this._server) {
            ...
            this._ws.on('open', async () => {
                ...
                this._call('', {
                    ...
                    data: { protocolData: protocol_data_converter_1.ilpAndCustomToProtocolData({ protocolMap }) }
                }).then(() => {
                    this._emitConnect();
                }).catch((err) => {
        ...
        const flags = await new Promise((resolve, reject) => {
            ...
            this.once('_first_time_connect', (authPacket) => {
                this.removeListener('disconnect', onDisconnect);
                resolve(authPacket ? protocol_data_converter_1.protocolDataToIlpAndCustom(authPacket.data).protocolMap : {});
            });
        });
